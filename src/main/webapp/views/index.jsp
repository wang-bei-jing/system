...
<head>
    ...
    <link href="${pageContext.request.contextPath}/corkstatic/assets/css/loader.css" rel="stylesheet" type="text/css" />
    <script src="${pageContext.request.contextPath}/corkstatic/assets/js/loader.js"></script>
    <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href="https://fonts.googleapis.com/css?family=Nunito:400,600,700" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/corkstatic/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="${pageContext.request.contextPath}/corkstatic/assets/css/plugins.css" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->

    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM STYLES -->
    <link href="${pageContext.request.contextPath}/corkstatic/plugins/apex/apexcharts.css" rel="stylesheet" type="text/css">
    <link href="${pageContext.request.contextPath}/corkstatic/assets/css/dashboard/dash_1.css" rel="stylesheet" type="text/css" />
    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <ul class="navbar-item theme-brand flex-row  text-center">
            <li class="nav-item theme-logo">
                <a href="index.html">
                    <img src="${pageContext.request.contextPath}/corkstatic/assets/img/logo.svg" class="navbar-logo" alt="logo">
                </a>
            </li>
            <li class="nav-item theme-text">
                <a href="index.html" class="nav-link"> 数据库软件综合实训管理系统 </a>
            </li>
        </ul>
                    ...
                    <div class="">
                        <a class="dropdown-item">
                            <div class="">
                                ...
                                <div class="media">
                                    <div class="user-img">
                                        <img class="usr-img rounded-circle" src="${pageContext.request.contextPath}/corkstatic/assets/img/profile-11.jpeg.jpg" alt="profile">
                                    </div>
                        ...
                        <a class="dropdown-item">
                            <div class="">
                                ...
                                <div class="media">
                                    <div class="user-img">
                                        <img class="usr-img rounded-circle" src="${pageContext.request.contextPath}/corkstatic/assets/img/profile-16.jpeg.jpg" alt="profile">
                                    </div>
                                    <div class="media-body">
                                        <div class="">
                        ...
                        <a class="dropdown-item">
                            <div class="">
                                ...
                                <div class="media">
                                    <div class="user-img">
                                        <img class="usr-img rounded-circle" src="${pageContext.request.contextPath}/corkstatic/assets/img/profile-34.jpeg.jpg" alt="profile">
                                    </div>
                                    <div class="media-body">
                                        <div class="">
                ...
                <div class="page-header">
                    ...
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><span>施昊晨</span></li>
                        </ol>
                    </nav>
...
<div class="main-container" id="container">
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="components" data-parent="#accordionExample">
                        <li>
                            <a href="${pageContext.request.contextPath}/topicSelectAll?sSno=${student.sno}" target="myfrm"> 全部课题 </a>
                        </li>
                        <li>
    ...
    <div id="content" class="main-content">
       <%-- <div class="layout-px-spacing">--%>
            <iframe src="${pageContext.request.contextPath}/myTopic?sSno=${student.sno}" id="myfrm"name="myfrm"  width="100%" height="100%" frameborder=0>
...
<script src="${pageContext.request.contextPath}/corkstatic/assets/js/libs/jquery-3.1.1.min.js"></script>
<script src="${pageContext.request.contextPath}/corkstatic/bootstrap/js/popper.min.js"></script>
<script src="${pageContext.request.contextPath}/corkstatic/bootstrap/js/bootstrap.min.js"></script>
<script src="${pageContext.request.contextPath}/corkstatic/plugins/perfect-scrollbar/perfect-scrollbar.min.js"></script>
<script src="${pageContext.request.contextPath}/corkstatic/assets/js/app.js"></script>
<script>
    $(document).ready(function() {
        App.init();
    });
</script>
<script src="${pageContext.request.contextPath}/corkstatic/assets/js/custom.js"></script>
<!-- END GLOBAL MANDATORY SCRIPTS -->

<!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
<script src="${pageContext.request.contextPath}/corkstatic/plugins/apex/apexcharts.min.js"></script>
<script src="${pageContext.request.contextPath}/corkstatic/assets/js/dashboard/dash_1.js"></script>
<!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
