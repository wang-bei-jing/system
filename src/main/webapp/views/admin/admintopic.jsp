        ...
        <div class="modal-header">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-10">
                    <a id="seeall"  href="${request}/adminTopicSelectByName" methods="post" class="btn btn-primary">查看全部课程</a>
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <li><a href="${pageContext.request.contextPath}/adminTopicSelectByName?name=${topicname}&pn=1">首页</a></li>
                        <c:if test="${topicList.hasPreviousPage }">
                            <li><a href="${pageContext.request.contextPath}/adminTopicSelectByName?name=${topicname}&pn=${topicList.pageNum-1}"
                        ...
                        <c:forEach items="${topicList.navigatepageNums }" var="page_Num">
                            ...
                            <c:if test="${page_Num != topicList.pageNum }">
                                <li><a href="${pageContext.request.contextPath}/adminTopicSelectByName?name=${topicname}&pn=${page_Num }">${page_Num }</a></li>
                            </c:if>
                        </c:forEach>
                        ...
                        <li><a href="${pageContext.request.contextPath}/adminTopicSelectByName?name=${topicname}&pn=${topicList.pages}">末页</a></li>
                    </ul>
                </nav>
            </div>
        </div>
