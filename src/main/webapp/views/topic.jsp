...
<div id="main_page" class="page-header">
    ...
    <div class="container" style="width: 100%">
        <div class="modal-header">
            <h1>全部课题信息 <small>(Information  of all topic)</small></h1>
            <!-- 按钮 -->
            <div class="row">
                <div class="col-md-8">
                    <form action="${pageContext.request.contextPath}/topicSelectByCname" method="post" class="navbar-form navbar-left" role="search">
                        <input  type="text" name="cname" class="form-control" placeholder="按课程名称查询">
