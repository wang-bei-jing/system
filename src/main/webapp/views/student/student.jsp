...
<header class="user_header">
    <row>
        ...
        <div class="col-md-2">
            <div class="navbar-header">
                ...
                <ul id="teachSetting" class="nav nav-list collapse secondmenu" style="background: #DBDBDB;border-radius: 15px">
                    ...
                    <li><a href="${pageContext.request.contextPath}/views/student/topic.jsp"><i class="glyphicon glyphicon-edit">&nbsp;</i>我的消息</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-offset-10">
            <div class="navbar-header">
                <a class="navbar-brand" href="${pageContext.request.contextPath}/views/student/studentpersonal.jsponal.jsp">
                    <i>&nbsp;</i>
                    <i>&nbsp;</i>
                    <i>&nbsp;</i>
                    <i>&nbsp;</i>
