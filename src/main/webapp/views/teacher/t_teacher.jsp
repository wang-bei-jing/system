    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <ul class="navbar-item theme-brand flex-row  text-center">
            ...
            <li class="nav-item theme-text">
                <a href="" class="nav-link">数据库软件实训综合管理系统</a>
            </li>
        </ul>
    ...
    <div id="content" class="main-content">
                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <a href="${pageContext.request.contextPath}/selectTopicByTno.do/?tno=${teacher.tno}" class="btn btn-primary">刷新</a>
                                </div>
                            </div>
                        </div>
                        <div class="widget-content widget-content-area">
                            <div class="table-responsive mb-4 style-1">
                                <table id="topics_Table" class="table style-1 table-hover non-hover">
                                    <thead>
                                    <tr>
        ...
        <div class="footer-wrapper">
            <div class="footer-section f-section-1">
                <p class="">Copyright © 2020 <a target="_blank" href="../../../designreset.html">DesignReset</a>, All rights <a href="">Reserved </a>.</p>
            </div>
