...
<head>
    ...
    <link href="${pageContext.request.contextPath}/static/cork/plugins/file-upload/file-upload-with-preview.min.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <script src="${pageContext.request.contextPath}/static/cork/plugins/file-upload/file-upload-with-preview.min.js"></script>
