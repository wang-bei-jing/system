    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <ul class="navbar-item theme-brand flex-row  text-center">
            <li class="nav-item theme-logo">
                <a href="${pageContext.request.contextPath}/views/teacher/t_index.jsp">
                    <img src="${pageContext.request.contextPath}/static/image/logo.png" class="navbar-logo" alt="logo">
                </a>
            </li>
            <li class="nav-item theme-text">
                <a href="${pageContext.request.contextPath}/views/teacher/t_index.jsp" target="_top" class="nav-link">首页</a>
            </li>
        </ul>
        ...
        <ul class="navbar-item flex-row ml-md-auto">
            <li class="nav-item dropdown user-profile-dropdown">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                    <img src="${pageContext.request.contextPath}/static/assets/img/profile-16.jpeg.jpg" alt="avatar">
                </a>
    ...
    <div class="sidebar-wrapper sidebar-theme">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled menu-categories ps" id="accordionExample">
                <li class="menu">
                    <a href="#person" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                    ...
                    <ul class="collapse submenu list-unstyled" id="person" data-parent="#accordionExample">
                        <li>
                            <a href="" target="mainFrame">我的信息</a>
                        </li>
                        <li>
                ...
                <li class="menu">
                    <a href="#topic" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                    ...
                    <ul class="collapse submenu list-unstyled" id="topic" data-parent="#accordionExample">
                        <li>
                            <a href="${pageContext.request.contextPath}/views/teacher/t_topic.jsp" target="mainFrame">我的课题</a>
                        </li>
                        <li>
                            <a href="javascript:void(0);" target="mainFrame">申请课题</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="student" data-parent="#accordionExample">
                        <li>
                            <a href="javascript:void(0);" target="mainFrame">学生课题申请</a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/views/teacher/t_student.jsp" target="mainFrame">我的学生</a>
                        </li>
                        <li>
                            <%--<a href="javascript:void(0);" target="mainFrame">成绩管理</a>--%>
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="score" data-parent="#student">
                                    <li>
                                        <a href="javascript:void(0);">平时成绩管理</a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);">验收成绩</a>
                                    </li>
                                </ul>
                        </li>
                    </ul>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="file" data-parent="#accordionExample">
                        <li>
                            <a href="javascript:void(0);" target="mainFrame">我的课题文件</a>
                        </li>
                        <li>
                            <a href="javascript:void(0);" target="mainFrame">学生上传文件</a>
                        </li>
                    </ul>
                </li>

                <li class="menu">
                    <a href="#comment" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file"><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path><polyline points="13 2 13 9 20 9"></polyline></svg>
                            <span>我的消息</span>
                        </div>
