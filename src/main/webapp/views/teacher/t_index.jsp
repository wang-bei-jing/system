            ...
            <ul class="list-unstyled menu-categories ps" id="accordionExample">
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="person" data-parent="#accordionExample">
                            <li>
                                <a href="${pageContext.request.contextPath}/views/teacher/t_person.jsp" target="mainFrame">我的信息</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/views/teacher/t_password.jsp" target="mainFrame">修改密码</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <c:if test="${teacher.identity==1}">
                        <li class="menu">
                        <a href="#topic1" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                        ...
                        <ul class="collapse submenu list-unstyled" id="student" data-parent="#accordionExample">
                            ...
                            <li>
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="score" data-parent="#student">
                                    ...
                                    <li>
                                        <a href="${pageContext.request.contextPath}/views/teacher/t_midterm.jsp" target="mainFrame">期中检查记录</a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/views/teacher/t_check.jsp" target="mainFrame">验收记录</a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/views/teacher/t_grade.jsp" target="mainFrame">学生总成绩</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
